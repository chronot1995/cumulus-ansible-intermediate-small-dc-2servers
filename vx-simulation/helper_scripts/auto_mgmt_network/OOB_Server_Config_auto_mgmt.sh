...
#    using topology data from: int-ansible-training-small-dc-2servers.dot
...
REPOSITORY="https://github.com/CumulusNetworks/int-ansible-training-small-dc-2servers"
REPONAME="int-ansible-training-small-dc-2servers"
